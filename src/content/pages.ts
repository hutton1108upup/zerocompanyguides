...
export const contentPages: ContentPage[] = [
  ...
  page({
    ...
    indexable: false,
    lastVerified: "2026-08-31",
    gameVersion: "Launch build — rules checked 2026-08-31; search-demand gate pending",
    spoiler: "minor",
    sources: [
      "ea-faq",
      "ea-tactics-basics",
    ...
    blocks: [
      ...
      {
        type: "warning",
        heading: "The publishing gate is still closed",
        body: "This source-backed draft is available for editorial review but remains noindex and sitemap-excluded until a distinct 28-day GSC intent or repeated player demand proves that it should stand apart from the Beginner and Characters guides.",
        tone: "cyan",
      },
      {
        type: "table",
  ...
  page({
    ...
    blocks: [
      ...
      {
        type: "cards",
        heading: "Which companion should you bring?",
