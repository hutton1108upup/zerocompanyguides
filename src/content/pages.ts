...
export const contentPages: ContentPage[] = [
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          { title: "Match a named Operator to the open job", label: "Characters & Companions", body: "Compare authored identities, roster limits and replacement consequences before choosing a name for the slot.", href: "/characters", tone: "green" },
        ],
      },
      {
        type: "faq",
  ...
  page({
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          { title: "Audit the complete roster", label: "Characters & Companions", body: "Separate authored identities, Custom recruits, Den staff and the roles that cannot be replaced one-for-one.", href: "/characters", tone: "cyan" },
  ...
  page({
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          { title: "Check who can cover the next mission", label: "Characters & Companions", body: "Review authored Operators, Custom recruits, injuries and replacement consequences without guessing recruitment chapters.", href: "/characters", tone: "cyan" },
  ...
  page({
    ...
    blocks: [
      ...
      {
        type: "table",
        heading: "Six story companions at a glance",
        intro: "Hawks is the commander; these six authored companions join the campaign around that fixed lead. The table stays at identity and repeatable tactical value instead of publishing an unverified unlock order or full skill tree.",
        caption: "Source-bounded companion comparison; exact builds and recruitment chapters remain outside this page until independently verified.",
        columns: ["Companion", "Confirmed identity", "Distinct roster value", "Evidence boundary"],
        rows: [
          ["Trick (CT-3301)", "Veteran clone trooper and Hawks ally", "A durable authored identity that anchors an early conventional squad role", "Identity is official; talent-by-talent ranking is not claimed"],
          ["Kabb Uppercut", "Felshi former prizefighter and veteran crook", "Close-range displacement and an identity built around his cybernetic arm", "Official identity; exact upgrade order remains unverified here"],
          ["Jae Mordant", "Former Ore-Baroness of Luunata", "An authored Operator tied to Luunata and assist-oriented squad decisions", "Identity is official; launch combat observations remain source-labeled"],
          ["Tel-Rea Vokoss", "Tognath Jedi Padawan", "The only confirmed Jedi Padawan Operator and therefore a non-interchangeable roster role", "Official developer boundary; losing her is not reduced to a generic class swap"],
          ["Cly Kullervo", "Mandalorian warrior from Clan Verminoth", "Unique Mandalorian mobility and displacement identity", "Official identity; best-build claims require a separate reproduced test"],
          ["Luco Bronc", "Umbaran sharpshooter", "Long-range authored identity connected to Umbara and the Republic occupation", "Official identity; exact recruitment chapter is not published here"],
        ],
      },
      {
        type: "table",
  ...
  page({
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          { title: "Choose an authored or Custom Operator", label: "Characters & Companions", body: "Compare roster categories, recruitment boundaries, Bonds and permanent-loss consequences before filling a squad job.", href: "/characters", tone: "cyan" },
