...
const intentTermsByPath: Record<string, readonly string[]> = {
  ...
  "/guides/reinforcements-and-extraction": ["reinforcements", "extraction"],
  "/guides/credits-and-den-upgrades": ["credits", "den"],
  "/walkthrough/retake-mordant-citadel": ["visser", "mordant citadel"],
